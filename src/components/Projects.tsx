		...
		<section id="projects" className="space-y-6">
			...
			<div className="flex flex-col md:flex-row gap-x-6 gap-y-2">
				...
				<div className="w-full">
					<h4 className="font-medium text-zinc-800 dark:text-zinc-100 mb-2">Component Library</h4>
					<p className="text-sm text-zinc-500 dark:text-zinc-300 loading-relaxed">
						Open-source React component library with TypeScript support. Features 50+ components with comprehensive
			...
			<div className="flex flex-col md:flex-row gap-x-6 gap-y-2">
				...
				/>
				<div className="w-full">
					<h4 className="font-medium text-zinc-800 dark:text-zinc-100 mb-2">Portfolio Website</h4>
					<p className="text-sm text-zinc-500 dark:text-zinc-300 leading-relaxed">
						Minimalist portfolio showcasing design and development work. Built with performance and accessibility in
						mind.
					</p>
					<div className="flex items-center gap-x-2.5 mt-2">
						<span className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded-sm text-zinc-500 dark:text-zinc-300 text-xs">
