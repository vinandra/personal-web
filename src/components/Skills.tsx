export default function Skills() {
	return (
		<section id="skills" className="space-y-6">
			<h3 className="text-sm uppercase tracking-wide font-medium text-zinc-500 dark:text-zinc-300">Skills</h3>
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				<div className="flex flex-col md:flex-row gap-x-6 gap-y-2">
					...
					<div className="w-full">
						<h4 className="font-medium text-zinc-800 dark:text-zinc-100 mb-1.5">JavaScript & Typescript</h4>
						<p className="text-sm text-zinc-500 dark:text-zinc-300 leading-relaxed">
							Expert in modern JavaScript (ES6+) and TypeScript for building type-safe applications.
						</p>
					</div>
				</div>
				<div className="flex flex-col md:flex-row gap-x-6 gap-y-2">
					...
					<div className="w-full">
						<h4 className="font-medium text-zinc-800 dark:text-zinc-100 mb-1.5">UI/UX Design</h4>
						<p className="text-sm text-zinc-500 dark:text-zinc-300 leading-relaxed">
				...
				<div className="flex flex-col md:flex-row gap-x-6 gap-y-2">
					...
					<div className="w-full">
						<h4 className="font-medium text-zinc-800 dark:text-zinc-100 mb-1.5">Backend Integration</h4>
						<p className="text-sm text-zinc-500 dark:text-zinc-300 leading-relaxed">
							Working with RESTful APIs, GraphQL, and modern backend services for full-stack development.
						</p>
					</div>
				</div>
				<div className="flex flex-col md:flex-row gap-x-6 gap-y-2">
					...
					<div className="w-full">
						<h4 className="font-medium text-zinc-800 dark:text-zinc-100 mb-1.5">Tooling & Automation</h4>
						<p className="text-sm text-zinc-500 dark:text-zinc-300 leading-relaxed">
							Setting up build tools, CI/CD pipelines, and development workflows for efficient delivery.
						</p>
					</div>
				</div>
			</div>
